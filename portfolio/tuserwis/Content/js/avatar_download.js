    ...
    $(input).fileuploader({
        ...
        thumbnails: {
            box: '<div class="fileuploader-wrapper">' +
                ...
                '<li><a data-action="fileuploader-remove"><div class="fileuploader-icon-trash"></div> ${captions.remove}</a></li>' +
                '</ul>' +
                '</div>',
        ...
        upload: {
            url: '/Content/js/temp-php-file-uploader/ajax_upload_file.php',
