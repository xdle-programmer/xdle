        ...
        <div class="header__block layout">
            ...
            <div class="header__item">
                <div class="header__menu">
                    <div class="header__menu-item animation-scroll" data-scroll-goal="#company">Migration</div>
                    <div class="header__menu-item animation-scroll" data-scroll-goal="#service">Services </div>
        ...
        <div class="first-screen__content layout">
            <div class="first-screen__content-item">
                ...
                <div class="first-screen__content-inner-page">
                    <div class="first-screen__content-inner-page-title">Migration from offline</div>
                    <div class="first-screen__content-inner-page-subtitle">World is on the verge of complete and global update. <br>The last control, prospective client elements
                        and investment methods stop working.
                    </div>
                    <div class="first-screen__content-inner-page-list">
                        <div class="first-screen__content-inner-page-list-item">
                            <div class="first-screen__content-inner-page-list-item-title">Adaptation </div>
                            <div class="first-screen__content-inner-page-list-item-text">We progressively dive into the digital world, and it means that for survival we need
                                to adapt.
                            </div>
                        </div>
                        <div class="first-screen__content-inner-page-list-item">
                            <div class="first-screen__content-inner-page-list-item-title">Strategy</div>
                            <div class="first-screen__content-inner-page-list-item-text">Business is not exception – there will survive that entrepreneur who is able and can adapt to
                                different situations and who knows, what he will do in the case of crisis – failure!
                            </div>
                        </div>
                    </div>
                    <div class="first-screen__content-inner-page-desc">The project "Made in Earth" offers in a completely new way look at your business. </div>
        ...
        <div class="service__block layout__block">
            <div class="service__header">
                <div class="service__header-title-block">
                    <div class="service__title">Objective</div>
                    <div class="service__subtitle">Use already known technologies in a single mechanism and initiate it in your market segment. </div>
                </div>
                <div class="service__header-desc">
                    Believe our extensive experience that 90% kinds  <span class="bold">offline</span> of offline business can be moved into <span class="bold">online</span> without loss,
                    increasing it and scaling further. You might not know about it, but after our communications you understand the true nature and immediately run into the patent office.
            ...
            <div class="service__items">
                <div class="service__item">
                    <div class="service__item-title">The idea</div>
                    <div class="service__item-text">
                        is that every of you now have a very brief opportunity to take your current business into the net and we, the team
                        of project ''Make on Eart'', will help you make this migration.
                    </div>
                </div>
                <div class="service__item">
                    <div class="service__item-title">We help</div>
                    <div class="service__item-text">
                ...
                <div class="service__item">
                    <div class="service__item-title">Make the simple calculation</div>
                    <div class="service__item-text">
                        There is your business.<br>
                        How many competitors do you have? 10-20-100? <br>
                        Just image, that you can go beyond your local business and fast scale it and become №1!
                    </div>
                </div>
                <div class="service__item">
                    <div class="service__item-title">Right now</div>
                    <div class="service__item-text">there are a lot of persons, wishing to make the migration of their business. We thoroughly consider certain business and make
                        the research until give the answer.
                    </div>
                </div>
            </div>
        </div>
