...
<noscript><div><img src="https://mc.yandex.ru/watch/62701246" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
<body class="english">
...
<div class="wrapper">
        ...
        <div class="header__block layout">
            ...
            <div class="header__item">
                <div class="header__menu">
                    <div class="header__menu-item animation-scroll" data-scroll-goal="#company">VR/AR</div>
                    <div class="header__menu-item animation-scroll" data-scroll-goal="#service">Service</div>
                    <a href="/#portfolio" class="header__menu-item">Portfolio</a>
        ...
        <div class="first-screen__content layout">
            <div class="first-screen__content-item">
                ...
                <div class="first-screen__content-inner-page">
                    <div class="first-screen__content-inner-page-title">Develop the projects with the virtual and augmented reality
                    </div>
                    <div class="first-screen__content-inner-page-subtitle">The virtual reality has become the huge business-industry in different areas:
                    </div>
                    <div class="first-screen__content-ar-list">
                        <div class="first-screen__content-ar-list-item">
                            <img src="../img/ar/ar-main-1.svg" class="first-screen__content-ar-list-item-icon">
                            <div class="first-screen__content-ar-list-item-text">Medicine </div>
                        </div>
                        <div class="first-screen__content-ar-list-item">
                            <img src="../img/ar/ar-main-2.svg" class="first-screen__content-ar-list-item-icon">
                            <div class="first-screen__content-ar-list-item-text">Education </div>
                        </div>
                        <div class="first-screen__content-ar-list-item">
                            <img src="../img/ar/ar-main-3.svg" class="first-screen__content-ar-list-item-icon">
                            <div class="first-screen__content-ar-list-item-text">Marketing </div>
                        </div>
                        <div class="first-screen__content-ar-list-item">
                            <img src="../img/ar/ar-main-4.svg" class="first-screen__content-ar-list-item-icon">
                            <div class="first-screen__content-ar-list-item-text">Industry </div>
                        </div>
                        <div class="first-screen__content-ar-list-item">
                            <img src="../img/ar/ar-main-5.svg" class="first-screen__content-ar-list-item-icon">
                            <div class="first-screen__content-ar-list-item-text">Property</div>
                        </div>
                    </div>
        ...
        <div class="first-screen__background">
            <div class="first-screen__video-wrapper">
                <div class="first-screen__video-block">
                    ...
                    <video class="first-screen__video" autoplay muted loop playsinline data-video-src="../video/video_"></video>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="service__block layout__block">
            <div class="service__header">
                <div class="service__header-title-block">
                    <div class="service__title">VR/AR solutions </div>
                </div>
            </div>
            <div class="service__ar-desc">
                <div class="service__ar-desc-title">We offer</div>
                <div class="service__ar-desc-subtitle">The full range of services on the development of applications with virtual and augmented reality:</div>
                <div class="service__ar-list-block">
                    <div class="service__ar-list">
                        <div class="service__ar-list-item">Design </div>
                        <div class="service__ar-list-item">Preparation and management of documentations </div>
                        <div class="service__ar-list-item">Software development of client and server part </div>
                        <div class="service__ar-list-item">Development of interface graphics </div>
                        <div class="service__ar-list-item">Creation of animation and visual effects</div>
                        <div class="service__ar-list-item">Testing </div>
                        <div class="service__ar-list-item">Preparation for publication </div>
                    </div>
                    <div class="service__ar-list-img" style="background: url(../img/ar/ar-desc.jpg)"></div>
                </div>
            </div>
            <div class="service__ar-process-title-main">Work phases:</div>
            <div class="service__ar-process">
                <div class="service__ar-process-item">
                    <div class="service__ar-process-icon">
                        <img class="service__ar-process-icon-img" src="../img/ar/ar-desc-1.svg">
                    </div>
                    <div class="service__ar-process-title">Signing of the documents</div>
                    <div class="service__ar-process-desc">
                                                Discuss the objective<br>
                        Calculate the project cost<br>
                ...
                <div class="service__ar-process-item">
                    <div class="service__ar-process-icon">
                        <img class="service__ar-process-icon-img" src="../img/ar/ar-desc-2.svg">
                    </div>
                    <div class="service__ar-process-title">Programming </div>
                    <div class="service__ar-process-desc">
                        Create 3D prototype of low and high detailing.<br>
                        Develop the project design and 3D-models preparation.
                    </div>
                </div>
                <div class="service__ar-process-item">
                    <div class="service__ar-process-icon">
                        <img class="service__ar-process-icon-img" src="../img/ar/ar-desc-3.svg">
                    </div>
                    <div class="service__ar-process-title">Testing </div>
                    <div class="service__ar-process-desc">
                        Testing<br>
                        Maintenance<br>
                        Insights during the work
                    </div>
                </div>
                <div class="service__ar-process-item">
                    <div class="service__ar-process-icon">
                        <img class="service__ar-process-icon-img" src="../img/ar/ar-desc-4.svg">
                    </div>
                    <div class="service__ar-process-title">The launch of the project </div>
                    <div class="service__ar-process-desc">
                        Maintenance.<br>
                        Summaries.
                    </div>
    ...
    <div class="lead" id="lead">
        <div class="lead__block layout__block">
            <div class="lead__title title title--center title--white">Do you have question?</div>
            <div class="lead__subtitle title title--white title--small">Complete the short form below</div>
            <form class="lead__form form-check" id="lead-form" data-form-name="Реклама: Рассчитать проект">
                ...
                <div class="lead__form-item lead__form-item--2-3">
                    <div class="lead__form-item-title">Describe your business</div>
                    <div class="lead__form-item-input-block">
                        <div class="input">
    ...
    <div class="review">
        <div class="review__block">
            ...
            <form class="review__form form-check form-check--white-error" id="review-form" data-form-name="Migration: Solicit feedback">
