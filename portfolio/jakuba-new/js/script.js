$(document).ready(function () {
    ...
    var headerMenu = new Menu('.header-new__button', '.header-new');
    ...
    function header_scroll() {
        if ($(window).scrollTop() > 0) {
            if ($('.header-new').hasClass('header-new--scroll') === false) {
                $('.header-new').addClass('header-new--scroll');
            }
        } else {
            $('.header-new').removeClass('header-new--scroll');
        }
    }
    ...
    $('.select-icon__item').on('click', function () {
        var $wrapper = $(this).closest('.select-icon');
        var $items = $wrapper.find('.select-icon__item');
        var $input = $wrapper.find('.select-icon__input');
