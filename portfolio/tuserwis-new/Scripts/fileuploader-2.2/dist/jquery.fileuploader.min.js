                ...
                f = {
                    init: function () {
                        ...
                        create: function () {
                            ...
                            function u(e) {
                                var t = $(e);
                                c.removeClass("fileuploader-no-thumbnail fileuploader-loading").html(t), d.html.hasClass("file-will-popup") && d.html.removeClass("file-will-popup").addClass("file-has-popup"), t.is("img") && t.attr("draggable", "false").on("load error", function (e) {
                                    "error" == e.type && h(), m(), null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s);
                                }), t.is("canvas") && null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s);
                            }

                            var c = d.html.find(".fileuploader-item-image"), i = d.data && d.data.readerSkip,
                                h = function () {
                                    c.addClass("fileuploader-no-thumbnail"), c.removeClass("fileuploader-loading").html(d.icon), d.html.hasClass("file-will-popup") && d.html.removeClass("file-will-popup").addClass("file-has-popup"), null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s);
                                }, m = function () {
                                    var e = 0;
                            ...
                            if (c.length) {
                                if (d.image = c.html("").addClass("fileuploader-loading"), (-1 < ["image", "video", "audio", "astext"].indexOf(d.format) || d.data.thumbnail) && f.isFileReaderSupported() && !i && (d.appended || n.thumbnails.startImageRenderer || e)) {
                                    ...
                                    var r = function (e, t) {
                                        var o = e.nodeName && "img" == e.nodeName.toLowerCase(), i = o ? e.src : e;
                                        if (n.thumbnails.canvasImage) {
                                            var r = document.createElement("canvas"), a = o ? e : new Image,
                                                l = function () {
                                                    f.editor.resize(this, r, n.thumbnails.canvasImage.width ? n.thumbnails.canvasImage.width : c.width(), n.thumbnails.canvasImage.height ? n.thumbnails.canvasImage.height : c.height(), !1, !0), f._assets.isBlankCanvas(r) ? h() : u(r), m();
                                                }, s = function (e) {
                                                    h(), m(), a = null;
                                                };
                                    ...
                                    return "string" == typeof t || "object" == typeof t ? r(t) : f.files.read(d, function () {
                                        d.reader.node && (d.reader.frame || "img" == d.reader.node.nodeName.toLowerCase()) ? r(d.reader.frame || d.reader.src, !0) : (h(), m());
                                    }, null, t, !0);
                                }
                                h();
                            } else m();
                            ...
                            if (!f.locked && n.thumbnails.popup && n.thumbnails._selectors.popup) {
                                var a = $(n.thumbnails.popup.container), u = a.find(".fileuploader-popup"),
                                    e = function () {
                                        ...
                                        u.removeClass("loading"), u.children(n.thumbnails._selectors.popup).length && ($.each(f._itFl, function (e, t) {
                                            ...
                                            d.reader.node && d.reader.node.pause && d.reader.node.pause(), $(window).off("keyup", t), a.css({
                                                overflow: "",
                                                width: ""
                                        ...
                                        }, d.reader.node ? (i && e.html(e.html().replace(/\$\{reader\.node\}/, '<div class="reader-node"></div>')).find(".reader-node").html(d.reader.node), d.reader.node.controls = !0, d.reader.node.currentTime = 0, d.reader.node.play && d.reader.node.play()) : i && e.find(".fileuploader-popup-node").html('<div class="reader-node"><div class="fileuploader-popup-file-icon">' + d.icon + "</div></div>"), $(window).on("keyup", t), a.css({
                                            overflow: "hidden",
                                            width: a.innerWidth()
                                        }), d.popup.html.find('[data-action="prev"], [data-action="next"]').removeAttr("style"), d.popup.html[1 != f._itFl.length && n.thumbnails.popup.arrows ? "addClass" : "removeClass"]("fileuploader-popup-has-arrows"), n.thumbnails.popup.loop || (0 == f._itFl.indexOf(d) && d.popup.html.find('[data-action="prev"]').hide(), f._itFl.indexOf(d) == f._itFl.length - 1 && d.popup.html.find('[data-action="next"]').hide()), f.editor.zoomer(d), d.editor && (d.popup.editor || (d.popup.editor = {}), f.editor.rotate(d, d.popup.editor.rotation || d.editor.rotation || 0, !0), d.popup.editor && d.popup.editor.cropper && (d.popup.editor.cropper.hide(!0), setTimeout(function () {
                                ...
                                0 == u.length && (u = $('<div class="fileuploader-popup"></div>').appendTo(a)), u.fadeIn(400).addClass("loading"), (-1 < ["image", "video", "audio", "astext"].indexOf(d.format) || -1 < ["application/pdf"].indexOf(d.type)) && !d.popup.html ? f.files.read(d, e) : e();
                            }
                        }
                    }, editor: {
                        rotate: function (e, t, o) {
                            ...
                            if (w.reader.node) if (w.popup.editor.cropper) e && (w.popup.editor.cropper.crop = e), w.popup.editor.cropper.init(e); else {
                                ...
                                w.popup.editor.cropper = {
                                    ...
                                    setDefaultData: function () {
                                        var e = w.popup.editor.cropper, t = e.$imageEl, o = t.width(), i = t.height(),
                                    ...
                                    mousemove: function (e) {
                                        var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                            o = ($(e.target), w.popup.editor.cropper), i = {
                            ...
                            if (s.popup && s.popup.html && $("html").find(s.popup.html).length) {
                                if (!s.popup.zoomer) {
                                    var e = s.popup.html, p = e.find(".fileuploader-popup-node"),
                            ...
                            function e() {
                                if (b.reader.node) {
                                    ...
                                    if (t.width = b.reader.width, t.height = b.reader.height, i.drawImage(this, 0, 0, b.reader.width, b.reader.height), void 0 !== b.editor.rotation) {
                                        ...
                                        var r = b.editor.rotation * Math.PI / 180, a = .5 * t.width, d = .5 * t.height;
                                        i.clearRect(0, 0, t.width, t.height), i.translate(a, d), i.rotate(r), i.translate(.5 * -b.reader.width, .5 * -b.reader.height), i.drawImage(this, 0, 0), i.setTransform(1, 0, 0, 1, 0, 0);
                                    }
                                    if (b.editor.crop) {
                                        var u = i.getImageData(b.editor.crop.left, b.editor.crop.top, b.editor.crop.width, b.editor.crop.height);
                                        t.width = b.editor.crop.width, t.height = b.editor.crop.height, i.putImageData(u, 0, 0);
                                    }
                                    var c = x || b.type || "image/jpeg", h = n.editor.quality || 90,
                                        m = t.toDataURL(c, h / 100), g = function (e, t) {
                                            var i = w ? f._assets.dataURItoBlob(e, c) : e;
                                            z || f.thumbnails.renderThumbnail(b, !0, t || e), y && y(i, b, l, p, o, s), null != n.editor.onSave && "function" == typeof n.editor.onSave && n.editor.onSave(i, b, l, p, o, s), f.set("listInput", null);
                                        };
                            ...
                            f._assets.isMobile() ? (i.onload = e, i.src = b.reader.src) : b.reader.node ? e.call(b.reader.node) : b.reader.read(function () {
                        ...
                        init: function () {
                            ...
                            function t() {
                                f.sorter.sort = {
                                    ...
                                    placeholder: n.sorter.placeholder ? $(n.sorter.placeholder) : a.html.clone().addClass("fileuploader-sorter-placeholder").html("")
                                }, $("body").css({
                                    "-webkit-user-select": "none",
                                    "-moz-user-select": "none",
                                    "-ms-user-select": "none",
                            ...
                            e.preventDefault(), f.sorter.sort && f.sorter.mouseup(), a && (n.sorter.selectorExclude && (i.is(n.sorter.selectorExclude) || i.closest(n.sorter.selectorExclude).length) || ($(n.thumbnails._selectors.sorter).on("click drop dragend dragleave dragover dragenter dragstart touchstart touchmove touchend touchcancel", function (e) {
                                e.preventDefault();
                            }), "mousedown" == o && t(), "touchstart" == o && (f.sorter.isTouchLongPress = !0, setTimeout(function () {
                                f.sorter.isTouchLongPress && (delete f.sorter.isTouchLongPress, t());
                            }, n.thumbnails.touchDelay ? n.thumbnails.touchDelay : 0)), $(document).on("mouseup touchend", f.sorter.mouseup)));
                        }, mousemove: function (e) {
                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                            ...
                            e.preventDefault();
                            var h = c.x - o.xItem, m = c.y - o.yItem, g = c.x - (a.prop("offsetLeft") || 0),
                        ...
                        prepare: function (t, e) {
                            ...
                            if (a.upload) {
                                ...
                                if (n.upload.chunk && a.file.slice) {
                                    var t = f._assets.toBytes(n.upload.chunk), i = Math.ceil(a.size / t, t);
                                ...
                                if (p.addClass("fileuploader-is-uploading"), a.upload.$ajax && a.upload.$ajax.abort(), delete a.upload.$ajax, delete a.upload.send, a.upload.status = "loading", a.html && (n.thumbnails._selectors.start && a.html.find(n.thumbnails._selectors.start).remove(), d()), a.upload.data) for (var h in a.upload.data) a.upload.data.hasOwnProperty(h) && a.upload.formData.append(h, a.upload.data[h]);
                            ...
                            if (!e && r && t.upload.$ajax && (e = {
                                ...
                                var a = new Date, d = e.loaded + (t.upload.chunk ? t.upload.chunk.loaded : 0),
                                    u = t.upload.chunk ? t.upload.chunk.size : e.total, c = Math.round(100 * d / u),
                                    h = t.upload.chunk && t.upload.chunk.xhrStartedAt ? t.upload.chunk.xhrStartedAt : i,
                                    m = (a.getTime() - h.getTime()) / 1e3, g = m ? d / m : 0, v = Math.max(0, u - d),
                                    b = Math.max(0, m ? v / g : 0), w = {
                                        loaded: d,
                        ...
                        add: function (e, t) {
                            ...
                            if (f.isFileReaderSupported() && !d.data.readerSkip) {
                                ...
                                if ("astext" == d.format) a.onload = function (e) {
                                    ...
                                    if (a.onload = function (e) {
                                        function t() {
                                            d.data && d.data.readerCrossOrigin && p.setAttribute("crossOrigin", d.data.readerCrossOrigin), p.src = e.target.result + (!d.data.readerForce && !i || h || c || -1 != e.target.result.indexOf("data:image") ? "" : (-1 == e.target.result.indexOf("?") ? "?" : "&") + "d=" + Date.now()), p.onload = function () {
                                                ...
                                                d.reader.node = p, d.reader.src = p.src, d.reader.width = p.width, d.reader.height = p.height, d.reader.ratio = f._assets.pxToRatio(d.reader.width, d.reader.height), b && u.revokeObjectURL(b), m(), c && (d.reader = {read: d.reader.read});
                                            }, p.onerror = function () {
                                                m(), d.reader = {read: d.reader.read};
                                            };
                                        }
                                    ...
                                    h ? n.thumbnails.useObjectUrl && n.thumbnails.canvasImage && u ? a.onload({target: {result: b = u.createObjectURL(d.file)}}) : a.readAsDataURL(d.file) : a.onload({target: {result: c ? d.data.thumbnail : d.file}});
                                    ...
                                    var v = document.createElement("iframe"),
                                        b = h ? u.createObjectURL(d.file) : (n.thumbnails.pdf.urlPrefix || "") + d.file;
                                    n.thumbnails.pdf.viewer || f._assets.hasPlugin("pdf") ? (v.onload = function () {
                                        d.reader.node = v, d.reader.src = v.src, v.style.display = "", m();
                                    }, v.src = (n.thumbnails.pdf.viewer || "") + b, v.style.display = "none", document.body.appendChild(v)) : m();
                        ...
                        toBytes: function (e) {
                            ...
                            }(e)) ? .2126 * t[0] + .7152 * t[1] + .0722 * t[2] : null);
                            ...
                            if (navigator.plugins && navigator.plugins.length) for (var t in navigator.plugins) if (-1 < navigator.plugins[t].name.toLowerCase().indexOf(e)) return !0;
                            return !1;
                        }, isIE: function () {
